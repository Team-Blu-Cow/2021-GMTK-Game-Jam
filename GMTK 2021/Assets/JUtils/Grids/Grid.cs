...
namespace JUtil.Grids
{
    ...
    public class Grid<T>
    {
        ...
        {
            if (pos.x < originPosition.x || pos.x >= width + originPosition.x || pos.y < originPosition.y || pos.y >= height + originPosition.y)
                return false;
            return true;
        }
        ...
        virtual public void DrawGizmos(Color drawGridColour, Color drawGridOutlineColour)
        {
            ...
            Vector3 startPos = new Vector3(originPosition.x, originPosition.y);
            Vector3 targetPos = new Vector3(startPos.x, startPos.y + height*cellSize);
            ...
            targetPos = new Vector3(startPos.x + width * cellSize, startPos.y);
            Gizmos.DrawLine(startPos, targetPos);
